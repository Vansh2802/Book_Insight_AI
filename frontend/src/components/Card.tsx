...
export function Card({ children, className = "", gradientBorder = false }: CardProps) {
  if (gradientBorder) {
    return (
      <div
        className={`rounded-2xl bg-linear-to-br from-emerald-400/60 via-teal-300/50 to-cyan-400/60 p-[1.5px] shadow-md transition-all duration-300 hover:shadow-xl dark:from-emerald-500/40 dark:via-teal-400/30 dark:to-cyan-500/40 ${className}`.trim()}
      >
